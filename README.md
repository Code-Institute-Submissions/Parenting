...
In the future, I would like to extend the project and write about toddler's life and challenges in their milestones development, to add more dynamicity and interaction for the users, like a forum for discussion and links to useful organisation relevant to the site users. Also, I want to create flyers with a well-structured information integrated into the webpages that can be printable and be used to inform women and parents about the most important things for having a healthy pregnancy and babies.<br/>
Also, I want to develop the topics and add more information related and relevant to the subject.<br/>
...
1.[Bootstrap (4.5.2):](https://www.bootstrapcdn.com/)
...
3.[Google Fonts](https://fonts.google.com/)
  -   Google fonts were used to import the 'Cardo' font into the style.css file which is used on all pages throughout the project and 'Exo' font, used on Pregnancy Page.   
...
6.[Balsamiq](https://balsamiq.com/) 
  -   Balsamiq was used to create the [wireframes](https://github.com/DomnicaH/Parenting/tree/main/documentation/wireframes) during the design process.

6.[Canva](https://www.canva.com/create/logos/)
  -   Canva was used to create the logo and dowload some images for the website.

7.[Unsplash](https://unsplash.com/)
  -   Unsplash was used to download some images for the website. 
